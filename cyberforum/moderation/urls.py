...
urlpatterns = [
    ...
    path(
        "documentation/", views.documentation_moderator_list, name="documentation_list"
    ),
    path(
        "documentation/create/", views.documentation_create, name="documentation_create"
    ),
    path(
        "documentation/<int:doc_id>/delete/",
        views.documentation_delete,
